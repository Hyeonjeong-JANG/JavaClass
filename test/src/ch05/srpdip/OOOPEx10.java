...
class 홍길동 extends 종업원{
	...
	요리사 y;//의존성 역전 원칙: 장보고 이순신에 의존하는 것이 아니라 추상적인 요리사에 의존
...
//임꺽정과 홍길동이 장보고가 아닌 요리사에 의존하고 있었기 때문에 정몽주가 새로운 요리사가 되어도 오류가 없다. 
