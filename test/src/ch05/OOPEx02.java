...
class CheeseHamburger extends Hamburger{//치즈버거는 햄버거이기 때문에 상속받을 수 있다.
	String name = "치즈햄버거";//이름이 겹치면 자기 이름을 쓴다. 겹치지 않는 상태(필드)만 물려받는다.
}
...
//상속도 되고 컴포지션도 되는데 왜 상속을 할까?! 다음 시간에 알아보자구!!!